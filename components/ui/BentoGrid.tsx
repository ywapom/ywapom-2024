...
export const BentoGridItem = ({
  ...
  const leftLists = ["Python", "Javascript", "SQL"];
  const rightLists = ["C#.Net", "Selenium", "Cypress"];
            ...
            <div className="flex gap-1 lg:gap-1 w-fit absolute -right-3 lg:-right-2">
              ...
              <div className="flex flex-col gap-1 md:gap-3 lg:gap-1">
                ...
                {rightLists.map((item, i) => (
                  <span
                    key={i}
                    className="lg:py-4 lg:px-3 lg:pr-6 py-2 px-3 text-xs lg:text-sm opacity-50 
                    lg:opacity-100 rounded-lg text-center bg-[#10132E]"
                  >
                    {item}
                  </span>
